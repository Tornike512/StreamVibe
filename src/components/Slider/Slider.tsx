...
export function Slider() {
  ...
  return (
    <ul
      className={`w-[374%] relative  grid grid-cols-[repeat(20,5%)] gap-x-[35px] transition-[left] duration-[0.5s] ease-[ease] delay-[0s] lg:grid-cols-[repeat(20,13%)] lg:overflow-x-auto`}
      style={{ left: `${slide}px` }}
    >
      {movies.map((movie) => {
        return (
